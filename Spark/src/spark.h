...
SPARKAPI SparkScalar SparkClamp(SparkScalar value, SparkScalar min,
                                SparkScalar max);
...
SPARKAPI SparkScalar SparkClamp(SparkScalar x, SparkScalar min_val,
                                SparkScalar max_val);
...
SPARKAPI SparkScalar SparkSmoothStep(SparkScalar edge0, SparkScalar edge1,
                                     SparkScalar x);
...
SPARKAPI SparkVec2 SparkVec2Clamp(SparkVec2 v, SparkVec2 min_val,
                                  SparkVec2 max_val);
...
SPARKAPI SparkVec2 SparkVec2SmoothStep(SparkVec2 edge0, SparkVec2 edge1,
                                       SparkVec2 x);

SPARKAPI SparkVec3 SparkVec3Min(SparkVec3 a, SparkVec3 b);
SPARKAPI SparkVec3 SparkVec3Max(SparkVec3 a, SparkVec3 b);
SPARKAPI SparkVec3 SparkVec3Clamp(SparkVec3 v, SparkVec3 min_val,
                                  SparkVec3 max_val);
...
SPARKAPI SparkVec3 SparkVec3SmoothStep(SparkVec3 edge0, SparkVec3 edge1,
                                       SparkVec3 x);

SPARKAPI SparkVec4 SparkVec4Min(SparkVec4 a, SparkVec4 b);
SPARKAPI SparkVec4 SparkVec4Max(SparkVec4 a, SparkVec4 b);
SPARKAPI SparkVec4 SparkVec4Clamp(SparkVec4 v, SparkVec4 min_val,
                                  SparkVec4 max_val);
...
SPARKAPI SparkVec4 SparkVec4SmoothStep(SparkVec4 edge0, SparkVec4 edge1,
                                       SparkVec4 x);
...
SPARKAPI SparkResult SparkInsertVector(SparkVector vector, SparkIndex index,
                                       SparkHandle element);
SPARKAPI SparkResult SparkRemoveVector(SparkVector vector, SparkIndex index);
SPARKAPI SparkResult SparkEraseVector(SparkVector vector, SparkIndex start,
                                      SparkIndex end);
SPARKAPI SparkResult SparkSetVector(SparkVector vector, SparkIndex index,
                                    SparkHandle element);
...
SPARKAPI SparkResult SparkInsertMap(SparkMap map, SparkConstBuffer key,
                                    SparkConstBuffer value);
SPARKAPI SparkResult SparkRemoveMap(SparkMap map, SparkConstBuffer key);
SPARKAPI SparkResult SparkSetMap(SparkMap map, SparkConstBuffer key,
                                 SparkConstBuffer value);
...
SPARKAPI SparkBool SparkContainsSet(SparkSet set, SparkHandle element,
                                    SparkCompareFunction compare);
SPARKAPI SparkResult SparkInsertSet(SparkSet set, SparkHandle element,
                                    SparkCompareFunction compare);
SPARKAPI SparkResult SparkRemoveSet(SparkSet set, SparkHandle element,
                                    SparkCompareFunction compare);
...
SPARKAPI SparkShader SparkCreateShader(SparkShaderType type,
...
SPARKAPI SparkResult SparkAttachShader(SparkProgram program,
                                       SparkShader shader);
...
SPARKAPI SparkResult SparkSetUniform1f(SparkProgram program,
                                       SparkConstString name, SparkF32 v0);
SPARKAPI SparkResult SparkSetUniform2f(SparkProgram program,
                                       SparkConstString name, SparkF32 v0,
                                       SparkF32 v1);
SPARKAPI SparkResult SparkSetUniform3f(SparkProgram program,
                                       SparkConstString name, SparkF32 v0,
                                       SparkF32 v1, SparkF32 v2);
SPARKAPI SparkResult SparkSetUniform4f(SparkProgram program,
                                       SparkConstString name, SparkF32 v0,
                                       SparkF32 v1, SparkF32 v2, SparkF32 v3);

SPARKAPI SparkResult SparkSetUniform1i(SparkProgram program,
                                       SparkConstString name, SparkI32 v0);
SPARKAPI SparkResult SparkSetUniform2i(SparkProgram program,
                                       SparkConstString name, SparkI32 v0,
                                       SparkI32 v1);
SPARKAPI SparkResult SparkSetUniform3i(SparkProgram program,
                                       SparkConstString name, SparkI32 v0,
                                       SparkI32 v1, SparkI32 v2);
SPARKAPI SparkResult SparkSetUniform4i(SparkProgram program,
                                       SparkConstString name, SparkI32 v0,
                                       SparkI32 v1, SparkI32 v2, SparkI32 v3);

/* Uniform setting functions for matrices */
SPARKAPI SparkResult SparkSetUniformMat2(SparkProgram program,
                                         SparkConstString name, SparkMat2 mat);
SPARKAPI SparkResult SparkSetUniformMat3(SparkProgram program,
                                         SparkConstString name, SparkMat3 mat);
SPARKAPI SparkResult SparkSetUniformMat4(SparkProgram program,
                                         SparkConstString name, SparkMat4 mat);

/* Attribute location functions */
SPARKAPI SparkResult SparkBindAttribLocation(SparkProgram program,
                                             SparkIndex index,
                                             SparkConstString name);
SPARKAPI SparkResult SparkGetAttribLocation(SparkProgram program,
                                            SparkConstString name,
                                            SparkIndex *location);
...
SPARKAPI SparkResult SparkGetUniformLocation(SparkProgram program,
                                             SparkConstString name,
                                             SparkIndex *location);

/* Shader utility functions */
SPARKAPI SparkResult SparkLoadShaderFromFile(SparkShader shader,
                                             SparkConstString filePath);
SPARKAPI SparkResult SparkSetShaderSource(SparkShader shader,
                                          SparkConstString source);

/* Uniform Buffer Object (UBO) functions */
typedef struct SparkUniformBufferT *SparkUniformBuffer;
SPARKAPI SparkUniformBuffer SparkCreateUniformBuffer(SparkSize size,
                                                     SparkConstBuffer data);
SPARKAPI SparkVoid SparkDeleteUniformBuffer(SparkUniformBuffer buffer);
SPARKAPI SparkResult SparkBindUniformBuffer(SparkProgram program,
                                            SparkConstString name,
                                            SparkUniformBuffer buffer);

/* Vertex Buffer functions */
typedef struct SparkVertexBufferT *SparkVertexBuffer;
SPARKAPI SparkVertexBuffer SparkCreateVertexBuffer(SparkSize size,
                                                   SparkConstBuffer data);
...
SPARKAPI SparkResult SparkSetVertexAttribPointer(
...
SPARKAPI SparkIndexBuffer SparkCreateIndexBuffer(SparkSize size,
                                                 SparkConstBuffer data);
...
/* Drawing functions */
SPARKAPI SparkResult SparkDrawArrays(SparkPrimitiveType mode, SparkIndex first,
                                     SparkSize count);
SPARKAPI SparkResult SparkDrawElements(SparkPrimitiveType mode, SparkSize count,
                                       SparkShaderDataType type,
                                       SparkSize offset);

/* Texture functions */
typedef struct SparkTextureT *SparkTexture;
SPARKAPI SparkTexture SparkCreateTexture2D(SparkI32 width, SparkI32 height,
                                           SparkConstBuffer data);
...
SPARKAPI SparkResult SparkSetTextureParameter(SparkTexture texture,
...
SPARKAPI SparkResult SparkFramebufferTexture2D(SparkFramebuffer framebuffer,
                                               SparkTexture texture);

/* Renderbuffer functions */
typedef struct SparkRenderbufferT *SparkRenderbuffer;
SPARKAPI SparkRenderbuffer SparkCreateRenderbuffer(SparkI32 width,
                                                   SparkI32 height);
...
SPARKAPI SparkResult SparkFramebufferRenderbuffer(
    SparkFramebuffer framebuffer, SparkRenderbuffer renderbuffer);

/* Render loop functions */
SPARKAPI SparkResult SparkClear(SparkU32 mask);
SPARKAPI SparkResult SparkSetClearColor(SparkF32 red, SparkF32 green,
                                        SparkF32 blue, SparkF32 alpha);
SPARKAPI SparkResult SparkSetViewport(SparkI32 x, SparkI32 y, SparkI32 width,
                                      SparkI32 height);
...
/* Blend functions */
SPARKAPI SparkResult SparkBlendFunc(SparkBlendMode sfactor,
...
SPARKAPI SparkVector SparkGetAllComponentsByEntity(SparkEcs ecs, SparkEntity entity_id);
...
SPARKAPI SparkEventHandler SparkCreateEventHandler(
    SparkEventHandlerFunction functions[], 
    SparkSize function_count);
